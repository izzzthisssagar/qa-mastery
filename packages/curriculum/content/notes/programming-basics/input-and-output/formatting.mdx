---
title: "Formatting"
summary: "Formatting is how you turn a raw value into readable text — two decimal places on a price, commas in a big number, columns that line up. The catch every tester must hold onto: formatting changes what you SEE, never what the value IS. A number rounded to two places on screen is still the long, messy number underneath — and confusing the two is a bug factory."
