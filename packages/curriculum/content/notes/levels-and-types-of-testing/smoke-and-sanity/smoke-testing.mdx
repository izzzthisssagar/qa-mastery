...
- **The CI pipeline's first automated stage after deploy** — a green smoke step is what unlocks every
  later stage; a red one should stop the pipeline outright. See [running tests in the pipeline](/notes/cicd/pipelines/test-in-pipeline) for how it slots in among lint, unit, integration, and e2e.
