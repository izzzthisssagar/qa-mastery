...
const HOTSPOTS: Hotspot[] = [
  {
    ...
    detail: "BS-012 · boundary · cart total ignores free-shipping rule at exactly $999",
    x: 22,
    y: 58,
  },
  {
    ...
    detail: "BS-007 · validation · qty=0 is accepted and adds a $0 line item",
    x: 71,
    y: 36,
  },
  {
    id: "a11y",
    label: "Double-click bypasses terms gate",
    detail: "BS-004 · logic · newsletter subscribes without terms accepted on double-click",
    x: 54,
    y: 80,
  },
];
