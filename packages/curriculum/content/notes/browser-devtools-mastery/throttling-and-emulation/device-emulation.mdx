...
updated: "2026-07-14"
related:
  - "browser-devtools-mastery/throttling-and-emulation/slow-3g-and-offline-mode"
  - "browser-devtools-mastery/throttling-and-emulation/testing-what-users-really-feel"
  - "browser-devtools-mastery/throttling-and-emulation/geolocation-and-sensors"
---
...
<HotspotImage
  src="/notes/browser-devtools-mastery/throttling-and-emulation/device-emulation.jpg"
  alt="Inside a full flight simulator cockpit: a projected runway visible through the windscreen, a bank of digital instrument screens on the main panel, overhead switch panels, a stationary pilot seat with headrest and harness, and a small keypad screen on the side console"
  credit="Full Flight Simulator, Thales/SuperJet International — Wikimedia Commons, CC BY-SA 2.0"
  pins={[
    { x: 45, y: 24, label: "The runway through the windscreen = the emulated viewport", desc: "That runway is a projection, not a real airfield - convincing enough to trigger the exact same reflexes a real approach would. Device emulation does the same to your page: it feeds the browser a fake viewport width and pixel ratio real enough that your CSS media queries and JS breakpoint checks fire exactly as they would on an actual phone." },
    { x: 58, y: 44, label: "The bank of instrument screens = preset vs. exact dimensions", desc: "Some of these displays show standardized readouts - the aviation equivalent of a device preset, a bundled set of known-good numbers. Others are configurable panels you dial in yourself, the same choice DevTools gives you: pick a named device preset, or type exact width and height in responsive mode when no preset matches the bug you're chasing." },
    { x: 59, y: 9, label: "The overhead switch panel = discrete toggles like DPR and touch", desc: "Row after row of binary switches, each one flipping a single specific condition on or off independent of everything else. That's exactly how DPR override and the touch-simulation toggle work in the device toolbar - separate switches you flip deliberately, not bundled into the device preset by default." },
    { x: 18, y: 36, label: "The stationary seat and harness = real hardware underneath the illusion", desc: "This chair never leaves the ground. Buckle in, and every instrument still convinces your body you're moving - but the hardware under you is a fixed rig in a warehouse. That's the honest core of emulation: real desktop hardware, a convincing fake layered on top, and a hard limit where the fakery stops fooling anyone." },
    { x: 70, y: 76, label: "The small keypad console = where you'd type exact values", desc: "Tucked on the side console, this compact screen-and-keypad unit is for precise data entry - not the big showy panels, just numbers typed in deliberately. It's the responsive-mode width/height fields in miniature: when the preset list doesn't have your number, you type it yourself." },
  ]}
/>
...
<Resources
  links={[
    ...
    { href: "https://www.youtube.com/watch?v=f7kokNyRe7U", title: "Chrome for Developers - simulate mobile devices with Device Mode", kind: "video" },
  ]}
/>

<Video href="https://www.youtube.com/watch?v=f7kokNyRe7U" title="Simulate mobile devices with Device Mode" minutes={4} />
