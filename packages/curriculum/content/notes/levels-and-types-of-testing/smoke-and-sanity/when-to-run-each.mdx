...
<Resources
  links={[
    ...
    { href: "/notes/automation-in-cicd/running-tests-in-ci/running-the-suite", title: "running the suite in CI - the speed-ordered CI stages smoke and sanity slot into", kind: "read" },
