...
This Code of Conduct applies within all community spaces for the QA Mastery
project — this repository's issues, pull requests, and discussions — and
...
reported to the project maintainer at **izzzthisssagar@gmail.com** with
`[conduct]` in the subject line. All complaints will be reviewed and
investigated promptly and fairly.

All community leaders are obligated to respect the privacy and security of
the reporter of any incident.

Security vulnerabilities (as opposed to conduct issues) should instead go to
