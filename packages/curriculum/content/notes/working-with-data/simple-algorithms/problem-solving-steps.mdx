...
- **The efficiency at scale** — a correct algorithm can still be too slow. If a step scans a list inside a loop, test with a big input (see [[working-with-data/key-value-data/when-to-use-which]]).
