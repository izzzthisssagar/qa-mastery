---
title: "Reading input"
summary: "The moment a program reads input from the outside world is the moment it becomes untrustworthy. Input always arrives as text — even when you asked for a number — and it arrives in whatever shape a human or another machine felt like sending. For a tester, the input boundary is where the most bugs live, because it's where your assumptions meet reality."
