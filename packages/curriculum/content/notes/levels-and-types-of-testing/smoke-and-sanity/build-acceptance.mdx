...
<Resources
  links={[
    ...
    { href: "/notes/automation-in-cicd/running-tests-in-ci/running-the-suite", title: "running the suite in CI - where BAT sits among lint, unit, integration, and e2e", kind: "read" },
