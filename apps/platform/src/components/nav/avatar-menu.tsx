  ...
  return (
    <DropdownMenu>
      <DropdownTrigger
        ...
        className="flex h-9 w-9 items-center justify-center rounded-full bg-accent text-sm font-semibold text-zinc-950 transition hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
      >
        {initial}
      </DropdownTrigger>
