...
the layer with the least authority to prove a fact true - see [[system-design-for-testers/from-architecture-to-test-strategy/what-to-test-at-which-layer]] on testing at the layer where a fact actually gets decided.
</Callout>
...
<StepChecklist
  steps={[
    ...
    { text: "If a DB client/admin panel is available, check the record directly", detail: "This is the ground truth. If the UI says one thing and the database says another, the database wins - see [[sql-and-databases-for-testers/verifying-the-app-against-the-db/ui-action-to-db-check]] for the deeper version of this check." },
  ]}
/>
