      ...
      <div className="flex flex-col md:flex-row gap-2 mb-8 relative">
        {PHASES.map((phase, idx) => {
          ...
          return (
            <div
              key={phase.id}
              className="flex-1 flex md:flex-col items-center group relative cursor-pointer"
            ...
            >
              ...
              {idx !== 0 && (
                <div className="md:hidden absolute left-6 bottom-1/2 w-[2px] h-full bg-surface-raised -z-10" />
              )}
