---
title: "Comments"
summary: "Comments are the lines the computer ignores and the humans read. They are also the only part of a program that can lie without breaking anything — because nothing checks whether a comment is still true. Learning to write comments that explain WHY, and to distrust comments that describe WHAT, is a skill that separates readable code from a minefield."
