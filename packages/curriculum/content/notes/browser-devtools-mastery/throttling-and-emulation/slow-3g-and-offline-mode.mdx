...
<HotspotImage
  src="/notes/browser-devtools-mastery/throttling-and-emulation/slow-3g-and-offline-mode.jpg"
  alt="A person on the floor wearing a red padded age-simulation suit and a white helmet with a tinted orange visor, black gloves, pushing themselves back up after a fall, in an ordinary office with unremarkable furniture visible in the background"
  credit="Doctor aged by the AgeExplorer suit, trying to get up after a simulated fall — Wikimedia Commons, CC BY-SA 4.0 (Gundolf Meyer-Hentschel)"
  pins={[
    { x: 53, y: 28, label: "The tinted, occluding visor = the Offline checkbox", desc: "Not fogged - blacked out. This visor doesn't slow what the wearer sees, it removes it. That is the difference between a preset and Offline: presets degrade a signal, Offline severs it outright, the same way every in-flight request just dies the instant you tick that box. Fog is a preset problem; a blackout is an Offline problem." },
    { x: 28, y: 51, label: "The glove dulling touch = a Custom profile", desc: "A generic thick glove is a preset; THIS glove was picked to produce one very specific loss of sensation. Custom profile is the same move on numbers instead of fabric - you're not accepting Chrome's idea of '3G', you're dialling in the exact latency-plus-bandwidth combination your actual support tickets describe, because no off-the-shelf preset matched them." },
    { x: 47, y: 45, label: "The padded suit at every joint = one preset applied everywhere", desc: "Shoulders, hips, knees - the same resistance is built into every joint at once, uniformly, the moment the suit goes on. That's exactly how a throttling preset works: pick 'Slow 4G' and EVERY request from that tab inherits the same download speed, upload speed, and latency - not just the one you're worried about." },
    { x: 83, y: 12, label: "The ordinary desk in the background = nothing else is touched", desc: "The furniture, the floor, the room are completely unaffected - only the person inside the suit experiences a different world. Network throttling works the same way: it caps requests from this one browser tab, full stop. Your other tabs, your real network, your colleague's laptop two feet away - all untouched, still running at full speed." },
    { x: 60, y: 72, label: "The gap between falling and standing = where the three bug species live", desc: "This exact moment - down, disoriented, not yet back on your feet - is where the note's whole point lives. Forever-spinners, double-submits, race conditions: none of them show up while everything responds instantly. They only exist in the gap between an action and the system catching up, and that gap is invisible until you deliberately manufacture it." },
  ]}
/>
...
<Resources
  links={[
    ...
    { href: "https://www.youtube.com/watch?v=aNNtuchVqV4", title: "The network throttling trick every support engineer must know", kind: "video" },
  ]}
/>

<Video href="https://www.youtube.com/watch?v=aNNtuchVqV4" title="The network throttling trick every support engineer must know" minutes={6} />
