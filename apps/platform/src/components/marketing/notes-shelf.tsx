...
const CARDS: Card[] = [
  {
    ...
    teaser: "Absolute zero — the physical parts, and how software comes alive on them.",
  },
  {
    no: "06",
    slug: "digital-literacy-and-safety",
    title: "Digital literacy & safety",
    teaser: "Accounts, passwords, phishing — the unglamorous skills that decide trust.",
  },
  {
    no: "11",
    slug: "programming-basics",
    title: "Programming basics",
    teaser: "The logic a tester needs before automating — Java and Python side by side.",
  },
  {
    no: "12",
    slug: "qa-foundations",
    title: "QA foundations",
    teaser: "How professional testing thinks — what QA is, and where it fits.",
  },
  {
    no: "18",
    slug: "testers-toolbox",
    title: "The Tester's Toolbox",
    teaser: "The free extensions and tools that separate a pro from a beginner.",
  },
  {
    no: "20",
    slug: "api-testing-fundamentals",
    title: "API testing fundamentals",
    teaser: "Reading HTTP itself, the status-code vocabulary, driving requests by hand.",
  },
  {
    no: "24",
    slug: "playwright",
    title: "Playwright",
    teaser: "Auto-waiting instead of sleeps, resilient locators, first-class traces.",
  },
  {
    no: "31",
    slug: "sql-and-databases-for-testers",
    title: "SQL & databases for testers",
    teaser: "Verifying data is daily manual-QA work — before any automation exists.",
  },
  {
    no: "37",
    slug: "performance-testing",
    title: "Performance testing",
    teaser: "Load, stress, and soak — the metrics that reveal how a system behaves.",
  },
  {
    no: "38",
    slug: "security-testing-web",
    title: "Security testing — web",
    teaser: "Authorization-bounded testing across OWASP risks, hands-on.",
  },
  {
    no: "44",
    slug: "ai-and-the-modern-tester",
    title: "AI & the modern tester",
    teaser: "Using AI critically, automating with it, and building judgment that lasts.",
  },
  {
    no: "48",
    slug: "your-first-90-days",
    title: "Your first 90 days",
    teaser: "Onboarding, solo-QA constraints, and picking a specialization on purpose.",
  },
];
