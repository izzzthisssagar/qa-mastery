    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          ...
          { slug: "ux-heuristics", title: "UX heuristics" },
          { slug: "accessibility-wcag", title: "Accessibility (WCAG)" },
          { slug: "assistive-tech", title: "Assistive tech" },
        ],
      },
      {
        slug: "compatibility",
        title: "Compatibility",
        topics: [
          { slug: "cross-browser", title: "Cross-browser" },
          { slug: "cross-device", title: "Cross-device" },
          { slug: "os-and-versions", title: "OS / versions" },
          { slug: "responsive-checks", title: "Responsive checks" },
        ],
      },
      {
        ...
        topics: [
          { slug: "i18n-vs-l10n-in-plain-words", title: "i18n vs l10n in plain words" },
          { slug: "text-expansion-truncation-and-rtl", title: "Text expansion, truncation & RTL" },
          { slug: "dates-currencies-and-formats", title: "Dates, currencies & formats" },
          { slug: "pseudo-localization-tricks", title: "Pseudo-localization tricks" },
        ],
      },
    ],
  },
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          ...
          { slug: "playwright-tool", title: "Playwright" },
          { slug: "cypress", title: "Cypress" },
          { slug: "choosing-a-tool", title: "Choosing a tool" },
        ],
      },
      {
        slug: "pitfalls",
        title: "Pitfalls",
        topics: [
          { slug: "flaky-tests", title: "Flaky tests" },
          { slug: "maintenance-cost", title: "Maintenance cost" },
          { slug: "over-automation", title: "Over-automation" },
          { slug: "false-confidence", title: "False confidence" },
        ],
      },
    ],
  },
    ...
    chapters: [
      {
        ...
        topics: [
          { slug: "webdriver-architecture", title: "WebDriver architecture" },
          { slug: "drivers-and-selenium-manager", title: "Drivers & Selenium Manager" },
          { slug: "first-script-java", title: "First script (Java)" },
          { slug: "first-script-python", title: "First script (Python)" },
        ],
      },
      {
        slug: "locators",
        title: "Locators",
        topics: [
          { slug: "id-name-css-xpath", title: "id / name / css / xpath" },
          { slug: "locator-strategy", title: "Locator strategy" },
          { slug: "relative-locators", title: "Relative locators" },
          { slug: "robust-selectors", title: "Robust selectors" },
        ],
      },
      {
        slug: "waits-and-sync",
        title: "Waits & sync",
        topics: [
          { slug: "implicit-vs-explicit", title: "Implicit vs explicit" },
          { slug: "fluent-waits", title: "Fluent waits" },
          { slug: "avoiding-sleeps", title: "Avoiding sleeps" },
          { slug: "handling-async", title: "Handling async" },
        ],
      },
      {
        ...
        topics: [
          { slug: "clicks-and-input", title: "Clicks & input" },
          { slug: "dropdowns-and-alerts", title: "Dropdowns & alerts" },
          { slug: "frames-and-windows", title: "Frames & windows" },
          { slug: "actions-api", title: "Actions API" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        title: "Tools intro",
        topics: [
          { slug: "jmeter", title: "JMeter" },
          { slug: "k6", title: "k6" },
          { slug: "designing-a-test", title: "Designing a test" },
          { slug: "reading-results", title: "Reading results" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          { slug: "threat-modeling-an-api", title: "Threat-modeling an API" },
          { slug: "a-repeatable-audit-checklist", title: "A repeatable audit checklist" },
          { slug: "chaining-findings", title: "Chaining findings" },
          { slug: "the-write-up-like-a-real-report", title: "The write-up (like a real report)" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          { slug: "axe-devtools-and-lighthouse", title: "axe DevTools & Lighthouse" },
          { slug: "wave", title: "WAVE" },
          { slug: "what-automation-catches-vs-misses", title: "What automation catches vs misses" },
          { slug: "ci-a11y-checks", title: "CI a11y checks" },
        ],
      },
      {
        ...
        topics: [
          { slug: "writing-a11y-findings-devs-act-on", title: "Writing a11y findings devs act on" },
          { slug: "aria-help-and-harm", title: "ARIA: help & harm" },
          { slug: "semantic-html-first", title: "Semantic HTML first" },
          { slug: "re-testing-a-fix", title: "Re-testing a fix" },
        ],
      },
    ],
  },
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          ...
          { slug: "battery-and-performance", title: "Battery & performance" },
          { slug: "app-lifecycle", title: "App lifecycle" },
          { slug: "store-testing", title: "Store testing" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          { slug: "shift-left", title: "Shift-left" },
          { slug: "the-cicd-pipeline", title: "The CI/CD pipeline" },
          { slug: "quality-gates", title: "Quality gates" },
          { slug: "continuous-testing", title: "Continuous testing" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          { slug: "test-summary-reports", title: "Test summary reports" },
          { slug: "coverage-and-pass-rate-metrics", title: "Coverage & pass-rate metrics" },
          { slug: "dashboards", title: "Dashboards" },
          { slug: "reporting-to-stakeholders", title: "Reporting to stakeholders" },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          { slug: "risk-based-testing", title: "Risk-based testing" },
          { slug: "prioritizing-what-to-test-first", title: "Prioritizing what to test first" },
          { slug: "test-estimation-techniques", title: "Test estimation techniques" },
          { slug: "saying-no-with-data", title: "Saying no with data" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          { slug: "self-healing-tests", title: "Self-healing tests" },
          { slug: "ai-test-generation-tools", title: "AI test generation tools" },
          { slug: "autonomous-testing-agents", title: "Autonomous testing agents" },
          { slug: "when-ai-automation-lies", title: "When AI automation lies" },
        ],
      },
      {
      ...
      },
      {
        ...
        topics: [
          { slug: "what-ai-wont-replace", title: "What AI won't replace" },
          { slug: "the-testers-judgment-premium", title: "The tester's judgment premium" },
          { slug: "learning-loop-for-new-tools", title: "Learning loop for new tools" },
          { slug: "ai-on-your-resume-honestly", title: "AI on your resume, honestly" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        title: "Profiles",
        topics: [
          { slug: "github-profile-polish", title: "GitHub profile polish" },
          { slug: "linkedin-for-qa", title: "LinkedIn for QA" },
          { slug: "personal-brand-basics", title: "Personal brand basics" },
          { slug: "posting-your-progress", title: "Posting your progress" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          { slug: "istqb-worth-it-or-not", title: "ISTQB — worth it or not" },
          { slug: "when-certs-matter", title: "When certs matter" },
          { slug: "free-alternatives", title: "Free alternatives" },
          { slug: "learning-in-public", title: "Learning in public" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        title: "Mock practice",
        topics: [
          { slug: "mock-interview-drills", title: "Mock interview drills" },
          { slug: "recording-yourself", title: "Recording yourself" },
          { slug: "feedback-loops", title: "Feedback loops" },
          { slug: "handling-rejection", title: "Handling rejection" },
        ],
      },
    ],
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        topics: [
          { slug: "payments-and-fintech-testing", title: "Payments & fintech testing" },
          { slug: "erp-crm-and-enterprise", title: "ERP / CRM & enterprise" },
          { slug: "games-iot-and-embedded", title: "Games, IoT & embedded" },
          { slug: "picking-a-niche-deliberately", title: "Picking a niche deliberately" },
        ],
      },
    ],
  },
