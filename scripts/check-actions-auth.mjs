...
// data-flow proof (same class of gate as check-rls-coverage.mjs). Ticket
// P1-10.
...
// hand against the real repo when this gate was added (P1-10, 2026-07). A
...
function main() {
  ...
  const violations = files.flatMap((file) =>
    findAuthViolations(file, readFileSync(file, "utf8"), new Set(ACTION_AUTH_EXEMPTIONS[file] ?? [])),
  );
